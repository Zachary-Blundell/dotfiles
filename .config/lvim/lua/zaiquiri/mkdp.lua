...
vim.g.mkdp_auto_start = vim.g.mkdp_auto_start or false
...
vim.g.mkdp_auto_close = vim.g.mkdp_auto_close or false
...
vim.g.mkdp_open_to_the_world = vim.g.mkdp_open_to_the_world or false
...
vim.g.mkdp_echo_preview_url = vim.g.mkdp_echo_preview_url or false
